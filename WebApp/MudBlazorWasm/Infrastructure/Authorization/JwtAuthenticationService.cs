...
using WUW.MicroManagerWasm.MudBlazorApp.Infrastructure.Common;
...
public class JwtAuthenticationService : AuthenticationStateProvider, IAuthenticationService, IAccessTokenProvider
{
    ...
    public override async Task<AuthenticationState> GetAuthenticationStateAsync()
    {
        try
        {
            ...
            {
                claimsIdentity.AddClaims(cachedPermissions.Select(p => new Claim(ApiClaims.Permission, p)));
            }
    ...
    public async Task<bool> LoginAsync(string tenantId, GetTokenRequest request)
    {
